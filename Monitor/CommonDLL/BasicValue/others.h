...
class COMMONDLL_EXPORT S_IPAddress : public QSerializer
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT SR_IPAddress : public TValueBase
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT S_TimeSlot : public QSerializer
{
    Q_GADGET
    QS_SERIALIZABLE
