...
class COMMONDLL_EXPORT S_Dic_StringBool : public QSerializer
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT S_Dic_IntString : public QSerializer
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT S_Dic_IntBool : public QSerializer
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT S_Dic_StringString : public QSerializer
{
    Q_GADGET
    QS_SERIALIZABLE
