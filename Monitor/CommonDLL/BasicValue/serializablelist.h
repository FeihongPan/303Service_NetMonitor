...
class COMMONDLL_EXPORT S_List_String : public QSerializer
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT S_List_Bool : public QSerializer
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT S_List_Double : public QSerializer
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT SR_List_Double : public TValueBase
{
    Q_GADGET
    QS_SERIALIZABLE
