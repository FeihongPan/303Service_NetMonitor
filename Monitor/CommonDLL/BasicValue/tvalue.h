...
class COMMONDLL_EXPORT TInt : public TValueBase
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT TDouble : public TValueBase
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT TBool : public TValueBase
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT TString : public TValueBase
{
    Q_GADGET
    QS_SERIALIZABLE
...
class COMMONDLL_EXPORT TEnum : public TValueBase
{
    Q_GADGET
    QS_SERIALIZABLE
