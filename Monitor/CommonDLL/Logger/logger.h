...
template <typename T>
struct COMMONDLL_EXPORT fmt::formatter<QList<T>>: fmt::formatter<std::string>
{
...
template <>
struct COMMONDLL_EXPORT fmt::formatter<QString> : fmt::formatter<std::string>
{
...
template <>
struct COMMONDLL_EXPORT fmt::formatter<QList<QString>>: fmt::formatter<std::string>
{
